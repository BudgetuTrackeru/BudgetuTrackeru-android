        ...
        if (savedInstanceState == null) {
            ...
            val fragment = TransactionDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(TransactionDetailFragment.ARG_ITEM_ID,
                            intent.getStringExtra(TransactionDetailFragment.ARG_ITEM_ID))
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
            when (item.itemId) {
                android.R.id.home -> {
                    ...
                    navigateUpTo(Intent(this, TransactionListActivity::class.java))
                    true
                }
